...
void RegionAU915InitDefaults( InitType_t type )
{
    switch( type )
    {
        case INIT_TYPE_INIT:
        {
            ...
            if((*((uint8_t *) (0x0ffff500u)))==0x00)
             ChannelsDefaultMask[0] = 0xFF00;
            
            switch(freqband_mask)
            {
               case 0x0001:ChannelsDefaultMask[0]=0x00FF;break;
                    
               case 0x0002:ChannelsDefaultMask[0]=0xFF00;break;
                    
               case 0x0004:ChannelsDefaultMask[1]=0x00FF;break;
                    
               case 0x0008:ChannelsDefaultMask[1]=0xFF00;break;
                    
               case 0x0010:ChannelsDefaultMask[2]=0x00FF;break;
                    
               case 0x0020:ChannelsDefaultMask[2]=0xFF00;break;
                    
               case 0x0040:ChannelsDefaultMask[3]=0x00FF;break;
                    
               case 0x0080:ChannelsDefaultMask[3]=0xFF00;break;
